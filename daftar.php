...
<html lang="en">
  ...
  <body>
    ...
    <h4 class="text-center mb-1 badge bg-danger fs-5 p-10 fw-bold">Daftar Sekarang</h4><br>
      <hr>
      <div class="alert alert-danger" role="alert"> Silahkan Masukan Username Dan Password Untuk Daftar </div>
      <div class="mb-3">
      ...
      <input type="password" name="password" placeholder="Password" class="form-control border border-primary"></div>
